...
# --- CLOCK CONFIGURATION FIX ---
# 1. Force the External Crystal (HSE) value to 12 MHz (matches your physical chip)
DEFINES += -DHSE_VALUE=50000000
# 2. Set the Target CPU Speed (STM32F405 standard max is 168MHz)
DEFINES += -DF_CPU=168000000L
# -------------------------------
